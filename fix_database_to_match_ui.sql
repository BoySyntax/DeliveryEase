...
-- The UI is correct (1000kg) but database is wrong (2000kg)
...
-- Verify the fix - database should now match UI
SELECT 
    b.id,
    b.barangay,
    b.total_weight as fixed_db_weight,
    b.max_weight,
    COUNT(o.id) as order_count,
...
-- Show summary
SELECT 
    'DATABASE FIXED TO MATCH UI' as status,
