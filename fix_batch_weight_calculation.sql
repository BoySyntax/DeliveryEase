-- Fix batch weight calculation and ensure proper batching
-- This addresses the issue where batch weights don't match actual order weights

-- First, let's see the current state
SELECT 'Current batches and their orders:' as info;
SELECT 
    b.id as batch_id,
    b.barangay,
...
-- Function to recalculate batch weights based on actual order weights
...
-- Function to fix batch assignment logic
...
-- Function to consolidate batches from the same barangay
...
SELECT 'After fix - batches and their orders:' as info;
SELECT 
    b.id as batch_id,
    b.barangay,
    b.total_weight as batch_total_weight,
...
-- Show final status
SELECT 'Batch weight calculation fixed and batching logic improved!' as status; 