-- COMPLETE FIX FOR ADDRESS SELECTION ISSUE
...
-- Step 2: Fix delivery addresses in orders table (using correct column names)
UPDATE orders o
SET delivery_address = (
  SELECT jsonb_build_object(
    ...
    'barangay', a.barangay,
    'region', COALESCE(a.region, 'Unknown'),
    'province', COALESCE(a.province, 'Unknown'),
    'city', COALESCE(a.city, 'Unknown'),
    'postal_code', COALESCE(a.postal_code, '0000'),
    'latitude', a.latitude,
