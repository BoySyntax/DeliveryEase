-- Simple fix for same barangay orders being in different batches
-- This script will consolidate orders without depending on other functions

-- First, let's see what we're working with
SELECT 'Current batches by barangay:' as info;
...
-- Clean up empty batches manually
DELETE FROM order_batches 
WHERE status = 'pending'
AND id NOT IN (
    SELECT DISTINCT batch_id 
