...
-- This migration consolidates existing batches from the same barangay and fixes the trigger
        ...
        LOOP
            ...
            BEGIN
                ...
                IF earliest_batch.id IS NOT NULL THEN
                    RAISE NOTICE '🔄 Merging batch % (% kg) into batch % (% kg) for barangay %', 
                    ...
                    RAISE NOTICE '✅ Successfully merged batch. New total weight: % kg', 
...
BEGIN
    ...
    IF NEW.approval_status = 'approved' AND (OLD.approval_status IS NULL OR OLD.approval_status != 'approved') THEN
        ...
        RAISE NOTICE '📊 Batch % capacity: % / % kg', 
