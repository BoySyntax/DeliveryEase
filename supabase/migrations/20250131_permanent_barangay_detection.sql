-- Permanent Barangay Detection Fix
-- This creates a robust function that will always properly extract barangay from delivery addresses
-- and ensures all batching works correctly with proper barangay detection

-- First, create a helper function to extract barangay from any address format
...
BEGIN
    ...
    IF full_address != '' THEN
        ...
        i := array_length(address_parts, 1);
        WHILE i >= 1 LOOP
